...
sudo wget -q -O /etc/bash_completion.d/keystone https://raw.githubusercontent.com/openstack/python-keystoneclient/master/tools/keystone.bash_completion
sudo wget -q -O /etc/bash_completion.d/glance https://raw.githubusercontent.com/openstack/python-keystoneclient/master/tools/keystone.bash_completion
